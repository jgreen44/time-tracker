...
export function buildInvoiceData(
  ...
  return {
    ...
    yourName:      params.yourName      || 'Your Name',
    yourCompany:   params.yourCompany   || 'Your Company LLC',
    yourAddress:   params.yourAddress   || '123 Main Street\nCity, State 12345',
    yourEmail:     params.yourEmail     || 'you@example.com',
    yourPhone:     params.yourPhone     || '(555) 123-4567',
    clientName:    params.clientName    || 'Acme Corporation',
    clientAddress: params.clientAddress || '456 Client Avenue\nNew York, NY 10001',
